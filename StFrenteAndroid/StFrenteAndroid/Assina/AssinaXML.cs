...
namespace StFrenteAndroid.Assina
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string _arquivo = ("C:\Documents and Settings\Amauri\Meus documentos\Meus arquivos recebidos\NotaEletro\AssinaXML\NFe.xml");
            if (_arquivo == null)
            {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    XMLDoc = doc;
                                    XMLDoc.Save("/storage/emulated/0/certificados/xml.xml");
                                }
    ...
    public class Certificado
    {
        public X509Certificate2 BuscaNome(string Nome)
        {
            ...
            try
            {
                ...
                foreach (var file in System.IO.Directory.GetDirectories("/storage/emulated/0/certificados"))
                {//Because you cannot delete a non-empty directory
                    files = files + " / "  + file.ToString();
                }
                _X509Cert = new X509Certificate2("/storage/emulated/0/certificados/ADRISIL (1234).pfx", "1234");
                //_X509Cert = new X509Certificate2("/storage/emulated/0/certificados/GazQuit.cer.crt", "1234");
                /*
